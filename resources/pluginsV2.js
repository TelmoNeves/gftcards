...
$(function() {
    ...
    giftcard.click(function(e) {
        e.preventDefault();
        if(this.className.indexOf("card-google") > -1){
        	window.location.href="https://bit.ly/3OUU2xO";
        }else if(this.className.indexOf("card-xbox") > -1){
        	window.location.href="https://bit.ly/3O0jctj";
        }else if(this.className.indexOf("card-steam") > -1){
        	window.location.href="https://bit.ly/3bQU2A4";
        }else if(this.className.indexOf("card-playstation") > -1){
        	window.location.href="https://bit.ly/3IpuBlr";
        }else if(this.className.indexOf("card-spotify") > -1){
        	window.location.href="https://bit.ly/3PjpBRM";
        }else if(this.className.indexOf("card-itunes") > -1){
			window.location.href="https://bit.ly/3ADSRys";
        }else if(this.className.indexOf("card-paypal") > -1){
        	window.location.href="https://bit.ly/3c2kXZX";
        }else if(this.className.indexOf("card-amazon") > -1){
        	window.location.href="https://bit.ly/3uDraln";
        }else{
        	window.location.href="https://bit.ly/3avnefB";
        }
